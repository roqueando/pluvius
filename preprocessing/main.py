...
def main():
    ...
    # TODO: cacular primeiro as features novas, pois há como agrupar por mes, e aplicar pra cada dia do mes as features corretas e depois só concatenar baseado no dia/mes/ano no novo df
    print(df.groupby('date')[['pmax']].min())
